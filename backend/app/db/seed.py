...
DEMO_UNITS = [
    ...
    {"id": "setor-pedagogico", "code": "SED-PED", "name": "Sede - Coordenação Pedagógica", "origin": "SEDE"},
    {"id": "setor-ti", "code": "SED-TI", "name": "Sede - Tecnologia da Informação", "origin": "SEDE"},
    {"id": "setor-rh", "code": "SED-RH", "name": "Sede - Recursos Humanos", "origin": "SEDE"},
]
...
DEMO_REQUESTS = [
    ...
    {
        "id": "req-2", "code": "CP-2026-0002", "origin": "SEDE", "unit_id": "setor-pedagogico",
    ...
    {
        "id": "req-4", "code": "CP-2026-0004", "origin": "SEDE", "unit_id": "setor-rh",
